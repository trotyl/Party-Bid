...
Activity.prototype.save = function () {
    Data.add(Data.read_list("activity_list"), this, "activity_list");
};
...
Activity.alter_status = function (name_of_activity, type_to_alter, status_to_alter) {
    var activity_list = Data.read_list("activity_list");
...
Activity.get_current_item = function () {
    ...
    return Data.check_if_contains(Data.read_list("activity_list"),{name: current_activity.name});
};

Activity.check_ifnot_null = function () {
    return !_.isEmpty(Data.read_list("activity_list"));
};

Activity.check_if_repeat = function (activity_name_to_check) {
    return Data.check_if_contains(Data.read_list("activity_list"), {name: activity_name_to_check});
};

Activity.check_if_one_on_progress = function () {
    return _(Data.read_list("activity_list")).some(function (activity_on_iterator) { 
        return activity_on_iterator.register == "run" || activity_on_iterator.bid == "run";});
};

Activity.find_by_name = function (name_to_find) {
    var object_found = Data.check_if_contains(Data.read_list("activity_list"), {name: name_to_find});
