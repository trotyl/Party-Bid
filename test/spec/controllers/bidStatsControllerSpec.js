...
describe('The BidStatsController', function () {
  ...
  beforeEach(function () {
    ...
    BidStatsController(scope, location, routeParams);
  });
  ...
  it('should be able to go to bid result', function () {
    scope.go_to_result();
    expect(location.path).toHaveBeenCalledWith('/detail/Activity 1/bid/1/result/false');
  });
